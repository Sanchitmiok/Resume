      ...
      />
        <div className='p-4 relative z-10 w-full text-center bgblu'>
            ...
            <p className=" mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">
               Lorem ipsum, dolor sit amet consectetur adipisicing elit. Placeat tempora in accusamus, animi distinctio atque voluptate ducimus possimus officiis, maiores incidunt fugiat, reprehenderit doloremque molestias? 
            </p>
            <div className='mt-4'>
               <Link href={"/courses"}>
